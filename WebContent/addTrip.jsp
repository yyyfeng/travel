...
<body>
	<form id="ff" action="trip?op=add">
		<input type="hidden" name="tripImg" value="" id='tripImg'>
	...
	<script type="text/javascript">
					...
					imgue
							.addListener(
									...
									function(t, arg) {
										...
										$("#span")
												.html(
														"<img  src='/travel/"+src+"' width='50' height='50'/>");
										$("#tripImg").val(src);
									})
				})
		function uploadImg(){
		...
		function uploadImg() {
			//alert(1);
			var myImage = imgue.getDialog("insertimage");
			myImage.open();
		}
