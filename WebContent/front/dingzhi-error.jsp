...
<body class="">
	...
	<div class="dztitle">
		<div class="container">
			<div class="os_img">
				<img src="images/o_error.png" alt="">
				<div class="ostll">预定失败</div>
				<a href="index.jsp">点击此处</a>返回<a href="index.jsp">主界面</a>或返回<a href="dingzhi.jsp">定制</a>界面
				<div class="oswtll">温馨提示：</div>
				<div class="oswinfo">
					非常感谢您来到游加<br> 如果您有其他问题可以联系客服<br>
					客服电话：400-705-1815
				</div>
			</div>
