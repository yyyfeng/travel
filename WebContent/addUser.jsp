...
<body class="">
	<div id="add">
		<form action="user?op=addUser" method="post">
			<div class="container">
				<div class="qtll">
					<div class="row">
						<div class="col-xs-2">
			...
			<div class="pmain">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txl">
								<input type="text" class="pc_text" name="nickName">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="pmlist">
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txl">
								<input type="text" class="pc_text" name="userName">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="pmlist">
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txl">
								<input type="text" class="pc_text" name="userAge">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txr">
								<input type="text" class="pc_text" name="userTel">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="pmlist">
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txr">
								<input type="password" class="pc_text" name="userPass">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txr ">
								<div class="p_down">
									<div class="birthday">
										<input id="dateTime" type="text" name="userBirth" date-time="2016-4-7" readonly>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="pmlist">
					<div class="container">
						<div class="row">
							...
							<div class="col-xs-8 txr ">
								<input type="email" class="pc_text" name="userEmail">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="pmfoot">
					<div class="col-xs-12 txc">
						<input type="submit" onclick="sub()" class="pass_sub" value="确认添加">
					</div>
				</div>
				<!--//.pmfoot-->
			</div>
